		...
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-info text-center" role="alert">
					<nav>
					  <ul class="pager">
					    <li class="previous"><a href="quartasdefinal"><span aria-hidden="true">&larr;</span> Quartas </a></li>
					    <li class="next"><a href="finais"> Final <span aria-hidden="true">&rarr;</span></a></li>
					  </ul>
					  <h2>SEMIFINAL</h2>
					</nav>
				</div>
																		...
																		echo '
																			<div class="row">
																				<div class="col-md-12 text-center">
																					...
																					<button type="button" class="btn btn-default atualizarpontossemifinal" data-bt="'.$value['id_jogo'].'">Atualizar pontos</button>
																				</div>
																			</div>
