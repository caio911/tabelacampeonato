		...
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-info text-center" role="alert">
					<nav>
					  <ul class="pager">
					    <li class="previous"><a href="oitavasdefinal"><span aria-hidden="true">&larr;</span> Oitavas </a></li>
					    <li class="next"><a href="semifinal"> Semi <span aria-hidden="true">&rarr;</span></a></li>
					  </ul>
					  <h2>QUARTAS DE FINAL <small>8 Times</small></h2>
					</nav>
				</div>
			</div>
		</div>
																		...
																		echo '
																			<div class="row">
																				<div class="col-md-12 text-center">
																					...
																					<button type="button" class="btn btn-default atualizarpontosquartasdefinal " data-bt="'.$value['id_jogo'].'">Atualizar pontos</button>
																				</div>
																			</div>
