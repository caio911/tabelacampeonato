		...
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-info text-center" role="alert">
					<nav>
					  <ul class="pager">
					    <li class="previous"><a href="primeirafase"><span aria-hidden="true">&larr;</span> Primeira </a></li>
					    <li class="next"><a href="quartasdefinal"> Quartas <span aria-hidden="true">&rarr;</span></a></li>
					  </ul>
					  <h2>Oitavas DE FINAL <small>8 Times</small></h2>
					</nav>
				</div>
			</div>
		</div>
														...
														<div class="partidas">
															<li>
																<form class="atualizar_pontos" method="post" id="<?php echo $value['id_jogo']; ?>">
																	...
																	<?php echo '<div class="row"><div class="col-md-12  text-center upper">'.$id_jogo_view.'</div></div>'; ?>
																		...
																		echo '
																			<div class="row">
																				<div class="col-md-12 text-center">
																					...
																					<button type="button" class="btn btn-default atualizarpontosoitavasdefinal " data-bt="'.$value['id_jogo'].'">Atualizar pontos</button>
																				</div>
																			</div>
